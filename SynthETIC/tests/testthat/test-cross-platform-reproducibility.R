...
#
# This test compares live output against a canonical macOS snapshot. See the
# stress test (test-cross-platform-stress.R) for a 10x-scale variant.
#
# When the *intended* numeric output of the simulator changes, regenerate the
# snapshot by running `data-raw/gen_cross_platform_snapshot.R` on the canonical
