...
# ---------------------------------------------------------------------------
# Pipeline runner. Mirrors gen_cross_platform_snapshot.R exactly so the live
# test and the snapshot generator always stay in lock-step. Parameterised by
# the snapshot's provenance fields so both the small and stress tests can share
...
# produced by gen_cross_platform_snapshot.R or gen_cross_platform_stress_snapshot.R).
